...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // footer
      'footer_text'             => 'بهترین قالب فروشگاهی ساخته شده در تاریخ وردپرس ایران',
      'footer_after'            => '',
      'footer_credit'           => '',
      ...
      echo '<div class="csf csf-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $this->args['show_form_warning'] ) ? '<div class="csf-form-result csf-form-warning">'. esc_html__( 'تغییرات شما هنوز ذخیره نشده. سریع تر ذخیره کنید', 'csf' ) .'</div>' : '';
            ...
            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="text" name="csf-search" placeholder="'. esc_html__( 'جستجو ...', 'csf' ) .'" autocomplete="off" /></div>' : '';
            ...
            echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'ریست سکشن', 'csf' ) .'" data-confirm="'. esc_html__( 'از ریست کردن تنظیمات این سکشن مطمئن هستید ؟', 'csf' ) .'">' : '';
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button csf-warning-primary csf-reset-all csf-confirm" value="'. ( ( $this->args['show_reset_section'] ) ? esc_html__( 'ریست همه', 'csf' ) : esc_html__( 'ریست', 'csf' ) ) .'" data-confirm="'. esc_html__( 'آیا مطمئن هستید قصد دارید تمام تنظیمات رو ریست کنید؟', 'csf' ) .'">' : '';
            echo '</div>';
